...
{
public:
	uint8                                        Pad_1D6A[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1D6C[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
