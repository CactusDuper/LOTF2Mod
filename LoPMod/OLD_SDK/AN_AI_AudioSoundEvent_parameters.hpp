...
struct UAN_AI_AudioSoundEvent_C_Received_Notify_Params
{
public:
	...
	float                                        CallFunc_ReportAISoundEventAtLocation_loudness_ImplicitCast; // 0x68(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_ReportAISoundEventAtLocation_soundRange_ImplicitCast; // 0x6C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x10 (0x10 - 0x0)
// Function AN_AI_AudioSoundEvent.AN_AI_AudioSoundEvent_C.GetNotifyName
struct UAN_AI_AudioSoundEvent_C_GetNotifyName_Params
{
public:
