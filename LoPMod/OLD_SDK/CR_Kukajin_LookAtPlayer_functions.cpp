...
class UClass* UCR_Kukajin_LookAtPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CR_Kukajin_LookAtPlayer_C");

	return Clss;
}


// CR_Kukajin_LookAtPlayer_C CR_Kukajin_LookAtPlayer.Default__CR_Kukajin_LookAtPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCR_Kukajin_LookAtPlayer_C* UCR_Kukajin_LookAtPlayer_C::GetDefaultObj()
{
	static class UCR_Kukajin_LookAtPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCR_Kukajin_LookAtPlayer_C*>(UCR_Kukajin_LookAtPlayer_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal CR_Kukajin_LookAtPlayer.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work CR_Kukajin_LookAtPlayer.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
