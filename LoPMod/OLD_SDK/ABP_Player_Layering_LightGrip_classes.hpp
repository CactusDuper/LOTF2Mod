...
{
public:
	uint8                                        Pad_350A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x350(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	struct FAnimBlueprintGeneratedMutableData_PLGG __AnimBlueprintMutables;                         // 0x358(0x2)(HasGetValueTypeHash)
