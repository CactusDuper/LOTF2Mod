...
{
public:
	uint8                                        Pad_2089[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_208B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_208C[0x9];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_208D[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
