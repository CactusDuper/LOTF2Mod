...
void AAnathemaPlayerCharacter_BP_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AnathemaPlayerCharacter_BP_C", "ReceiveTick");

	Params::AAnathemaPlayerCharacter_BP_C_ReceiveTick_Params Parms{};
