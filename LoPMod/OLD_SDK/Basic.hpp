...
public:
	...
	inline void Add(const T& Element)
	{
		...
		{
			// The array is full, so you may want to resize it here.
			// For simplicity, we'll double the array size in this example.
			int32 NewMaxElements = (MaxElements == 0) ? 1 : MaxElements * 2;
			Data = reinterpret_cast<T*>(realloc(Data, sizeof(T) * NewMaxElements));
...
public:
	...
	uint8                                        Pad_43A2[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43A3[0x8];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x40[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_43A4[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43A5[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43A6[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43A7[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43A8[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43A9[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43AA[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43AB[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_43AC[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
