...
{
public:
	uint8                                        Pad_34B5[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_34B6[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_34B7[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
