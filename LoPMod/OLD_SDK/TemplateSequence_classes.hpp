...
public:
	...
	uint8                                        Pad_D1E[0x7C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D1F[0x260];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D20[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D26[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D27[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D29[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
