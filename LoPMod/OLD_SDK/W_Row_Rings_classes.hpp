...
class UW_Row_Rings_C : public UEquipmentCategoryRow
{
public:
	...
	static class UW_Row_Rings_C* GetDefaultObj();

	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_W_Row_Rings(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
