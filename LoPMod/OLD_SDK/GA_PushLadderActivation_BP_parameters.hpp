...
struct UGA_PushLadderActivation_BP_C_K2_ActivateAbilityFromEvent_Params
{
public:
...
struct UGA_PushLadderActivation_BP_C_ExecuteUbergraph_GA_PushLadderActivation_BP_Params
{
public:
	...
	class ABP_KickableLadder_C*                  K2Node_DynamicCast_AsBP_Kickable_Ladder;           // 0xD0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
