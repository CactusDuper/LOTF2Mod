...
class UW_Row_Armor_C : public UEquipmentCategoryRow
{
public:
	...
	static class UW_Row_Armor_C* GetDefaultObj();

	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_W_Row_Armor(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
