...
class UClass* UCR_IceWolf_Blinking_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CR_IceWolf_Blinking_C");

	return Clss;
}


// CR_IceWolf_Blinking_C CR_IceWolf_Blinking.Default__CR_IceWolf_Blinking_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCR_IceWolf_Blinking_C* UCR_IceWolf_Blinking_C::GetDefaultObj()
{
	static class UCR_IceWolf_Blinking_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCR_IceWolf_Blinking_C*>(UCR_IceWolf_Blinking_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal CR_IceWolf_Blinking.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work CR_IceWolf_Blinking.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
