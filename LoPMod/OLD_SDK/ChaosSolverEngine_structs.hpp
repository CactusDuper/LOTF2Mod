...
{
public:
	uint8                                        Pad_2A65[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2A66[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2A67[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
