...
public:
	...
	uint8                                        BitPad_228 : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_22B : 2;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_291F[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_292B[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_292C[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2935[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_293E[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2941[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2943[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
