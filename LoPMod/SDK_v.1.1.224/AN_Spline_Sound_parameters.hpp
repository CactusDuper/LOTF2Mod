...
public:
	...
	uint8                                        Pad_3FA9[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	bool                                         CallFunc_isDebugNecessary_ShowDebug;               // 0x24(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetLOTF2GameMode_IsValid;                 // 0x25(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3FB2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ALOTF2GameMode*                        CallFunc_GetLOTF2GameMode_GameMode;                // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	enum class EWorldResetReason                 K2Node_CustomEvent_resetReason;                    // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_PostAssociatedAkEventAsync_PlayingID;     // 0x4C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_RandomFloatInRange_Min_ImplicitCast;      // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       CallFunc_Add_DoubleDouble_A_ImplicitCast;          // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_VariableSet_TickIntervalOutOfRange_ImplicitCast; // 0x70(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
