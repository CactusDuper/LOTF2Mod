...
{
public:
	uint8                                        Pad_1296[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1298[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_129A[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
