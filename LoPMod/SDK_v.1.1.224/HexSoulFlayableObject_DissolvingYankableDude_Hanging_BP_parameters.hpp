...
struct AHexSoulFlayableObject_DissolvingYankableDude_Hanging_BP_C_OnDissolveStart_Event_Params
{
public:
...
struct AHexSoulFlayableObject_DissolvingYankableDude_Hanging_BP_C_ExecuteUbergraph_HexSoulFlayableObject_DissolvingYankableDude_Hanging_BP_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_IsReverse;                            // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
