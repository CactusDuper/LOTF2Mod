...
{
public:
	uint8                                        Pad_2B4E[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2B56[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2BE0[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2BE2[0xE];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
