...
{
public:
	uint8                                        Pad_1FB8[0x130];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FB9[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1FBC[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FC0[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FC1[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FC4[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
