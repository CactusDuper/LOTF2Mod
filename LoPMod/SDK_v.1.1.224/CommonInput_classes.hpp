...
public:
	...
	uint8                                        Pad_1A8[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B7[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B9[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
