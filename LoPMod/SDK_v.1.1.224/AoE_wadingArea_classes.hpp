...
class AAoE_wadingArea_C : public AGameplayEffectsAreaActor
{
public:
	...
	static class AAoE_wadingArea_C* GetDefaultObj();
	...
	void ExecuteUbergraph_AoE_wadingArea(int32 EntryPoint, class AActor* K2Node_Event_Actor_that_called, class AActor* K2Node_Event_InteractorPlayer, enum class EGameRealm K2Node_ComponentBoundEvent_newRealm, bool CallFunc_EqualEqual_ByteByte_ReturnValue);
};
