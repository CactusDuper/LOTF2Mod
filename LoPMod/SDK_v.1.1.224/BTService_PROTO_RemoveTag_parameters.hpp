...
struct UBTService_PROTO_RemoveTag_C_ReceiveActivationAI_Params
{
public:
...
struct UBTService_PROTO_RemoveTag_C_ReceiveDeactivationAI_Params
{
public:
	class AAIController*                         OwnerController;                                   // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APawn*                                 ControlledPawn;                                    // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UBTService_PROTO_RemoveTag_C_ExecuteUbergraph_BTService_PROTO_RemoveTag_Params
{
public:
	...
	class AAIController*                         K2Node_Event_OwnerController;                      // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
