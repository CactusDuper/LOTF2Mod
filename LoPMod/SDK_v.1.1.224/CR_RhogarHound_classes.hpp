...
class URigVMMemory_Literal_RH : public URigVMMemoryStorage
{
public:
	...
	static class UClass* StaticClass();
	static class URigVMMemory_Literal_RH* GetDefaultObj();

};

// 0x1638 (0x1660 - 0x28)
// RigVMMemoryStorageGeneratorClass CR_RhogarHound.RigVMMemory_Work
class URigVMMemory_Work_RH : public URigVMMemoryStorage
{
public:
	...
	uint8                                        Pad_372F[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_26A : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_3735[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_373B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_373E[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3744[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UClass* StaticClass();
	static class URigVMMemory_Work_RH* GetDefaultObj();
