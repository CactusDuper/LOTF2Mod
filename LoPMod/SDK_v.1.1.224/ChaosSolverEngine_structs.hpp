...
{
public:
	uint8                                        Pad_2A96[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2A98[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2A9B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
