...
class UABP_EnemyBase_C* UABP_Investigator_Layer_C::GetABP_EnemyThreadSafe(class UABP_EnemyBase_C* K2Node_DynamicCast_AsABP_Enemy_Base, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ABP_Investigator_Layer_C", "GetABP_EnemyThreadSafe");

	Params::UABP_Investigator_Layer_C_GetABP_EnemyThreadSafe_Params Parms{};
...
// class UABP_EnemyBase_C*            CallFunc_GetABP_EnemyThreadSafe_ReturnValue                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UABP_Investigator_Layer_C::Update_LookAtAlpha(struct FAnimUpdateContext& Context, struct FAnimNodeReference& Node, class UABP_EnemyBase_C* CallFunc_GetABP_EnemyThreadSafe_ReturnValue, float CallFunc_GetDeltaTime_ReturnValue, float CallFunc_GetCurveValueWithDefault_OutValue, bool CallFunc_GetCurveValueWithDefault_ReturnValue, double CallFunc_SelectFloat_ReturnValue, double CallFunc_FInterpTo_ReturnValue, double CallFunc_FInterpTo_DeltaTime_ImplicitCast, double CallFunc_SelectFloat_A_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ABP_Investigator_Layer_C", "Update_LookAtAlpha");

	Params::UABP_Investigator_Layer_C_Update_LookAtAlpha_Params Parms{};

	Parms.Context = Context;
	Parms.Node = Node;
	Parms.CallFunc_GetABP_EnemyThreadSafe_ReturnValue = CallFunc_GetABP_EnemyThreadSafe_ReturnValue;
