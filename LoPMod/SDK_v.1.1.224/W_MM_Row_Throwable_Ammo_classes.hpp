...
class UW_MM_Row_Throwable_Ammo_C : public UEquipmentCategoryRow
{
public:
	...
	static class UW_MM_Row_Throwable_Ammo_C* GetDefaultObj();

	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_W_MM_Row_Throwable_Ammo(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
