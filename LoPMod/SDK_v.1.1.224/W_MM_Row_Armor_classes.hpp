...
class UW_MM_Row_Armor_C : public UEquipmentCategoryRow
{
public:
	...
	bool                                         Show_Category_Icon;                                // 0x3A0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_MM_Row_Armor_C* GetDefaultObj();

	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_W_MM_Row_Armor(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
