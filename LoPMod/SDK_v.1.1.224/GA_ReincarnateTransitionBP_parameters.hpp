...
struct UGA_ReincarnateTransitionBP_C_ExecuteUbergraph_GA_ReincarnateTransitionBP_Params
{
public:
	...
	class ATranscendLookController_C*            K2Node_DynamicCast_AsTranscend_Look_Controller;    // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerState*                          CallFunc_Array_Get_Item;                           // 0x40(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ALOTF2PlayerState*                     K2Node_DynamicCast_AsLOTF2Player_State;            // 0x78(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	enum class EHexMultiplayerRole               CallFunc_GetMultiplayerRole_ReturnValue;           // 0x90(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8B[0x7];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	class AAnathemaPlayerCharacter_BP_C*         K2Node_DynamicCast_AsAnathema_Player_Character_BP_1; // 0x98(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8E[0x6];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	double                                       CallFunc_Add_DoubleDouble_ReturnValue;             // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                CallFunc_GetOwningActorFromActorInfo_ReturnValue_2; // 0xB0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FActiveGameplayEffectHandle           CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue; // 0xC0(0x8)(NoDestructor, HasGetValueTypeHash)
};
