...
{
public:
	uint8                                        Pad_24BB[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24BC[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_24C0[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24C1[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
