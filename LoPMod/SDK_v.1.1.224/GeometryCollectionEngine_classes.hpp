...
{
public:
	uint8                                        Pad_2A8A[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_236 : 4;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_2AB5[0x170];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2B06[0xE8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B0C[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B11[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B20[0x288];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2B3A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B4A[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2B4B[0xD6];                                    // Fixing Size Of Struct [ Dumper-7 ]
