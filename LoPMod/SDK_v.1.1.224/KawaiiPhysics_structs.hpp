...
public:
	...
	uint8                                        Pad_202F[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2036[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_203B[0x4F];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_203C[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
