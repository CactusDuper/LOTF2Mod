...
public:
	...
	uint8                                        Pad_B94[0x7C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B97[0x260];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B99[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BA8[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BA9[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BAA[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
