...
{
public:
	uint8                                        Pad_2A77[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A78[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A85[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A86[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A89[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
