...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_IsInSoulFlayedState_Params
{
public:
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_UserConstructionScript_Params
{
public:
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_OnNotifyEnd_724C9397456136B3A5B0B68F222755E1_Params
{
public:
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_OnNotifyBegin_724C9397456136B3A5B0B68F222755E1_Params
{
public:
	class FName                                  NotifyName;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_OnInterrupted_724C9397456136B3A5B0B68F222755E1_Params
{
public:
	class FName                                  NotifyName;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_OnBlendOut_724C9397456136B3A5B0B68F222755E1_Params
{
public:
	class FName                                  NotifyName;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_OnCompleted_724C9397456136B3A5B0B68F222755E1_Params
{
public:
	class FName                                  NotifyName;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_PlayAnimMontage_Params
{
public:
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_SetSoulFlayTargetingEnabled_Params
{
public:
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_BndEvt__HexSoulFlayableObject_attached_v2_BP_SoulFlayComponent_K2Node_ComponentBoundEvent_0_SoulPullStartedDelegate__DelegateSignature_Params
{
public:
...
struct AHexSoulFlayableObject_SimpleYankableDude_BP_C_ExecuteUbergraph_HexSoulFlayableObject_SimpleYankableDude_BP_Params
{
public:
	...
	enum class ECollisionEnabled                 Temp_byte_Variable;                                // 0x6D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ECollisionEnabled                 Temp_byte_Variable_1;                              // 0x6E(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_43BD[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UAnimMontage*                          K2Node_CustomEvent_MontageToPlay;                  // 0x70(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_CustomEvent_PlayRate;                       // 0x78(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_CustomEvent_StartingPosition;               // 0x7C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_CustomEvent_bEnabled;                       // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Not_PreBool_ReturnValue;                  // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ECollisionEnabled                 K2Node_Select_Default;                             // 0x9A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                K2Node_ComponentBoundEvent_Instigator;             // 0xA8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FVector                               K2Node_ComponentBoundEvent_PullDirectionWS;        // 0xB0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UNiagaraComponent*                     CallFunc_SpawnSystemAtLocation_ReturnValue;        // 0xF0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_RandomFloatInRange_Max_ImplicitCast;      // 0x108(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Delay_Duration_ImplicitCast;              // 0x110(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_PlayAnimMontage_StartingPosition_ImplicitCast; // 0x114(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_PlayAnimMontage_PlayRate_ImplicitCast;    // 0x118(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
