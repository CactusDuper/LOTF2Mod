...
class ABP_ITM_PLA_EstusNullifier_C : public AItemVisual
{
public:
	...
	static class ABP_ITM_PLA_EstusNullifier_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_ITM_PLA_EstusNullifier(int32 EntryPoint);
};
