...
class AAN_Ambient_Sound_Umbral_C : public AActor
{
public:
	...
	uint8                                        Pad_436C[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	double                                       Init_Radius;                                       // 0x368(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       End_Radius;                                        // 0x370(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void Show_Debug_Script(const struct FVector& CallFunc_GetMCAKWorldLocation_MCAkWorldLocation, bool CallFunc_GetMCAKWorldLocation_ValidLocation, const class FString& CallFunc_GetDisplayName_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue_1, double CallFunc_Vector_Distance_ReturnValue, const class FString& CallFunc_Conv_DoubleToString_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue_2);
