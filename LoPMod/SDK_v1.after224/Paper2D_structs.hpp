...
{
public:
	uint8                                        Pad_21C7[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_21CE[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
