...
public:
	...
	uint8                                        Pad_1BB5[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
// 0x20 (0x20 - 0x0)
// ScriptStruct CommonUI.CommonVideoSubtitleData
struct FCommonVideoSubtitleData
{
public:
	class FText                                  Text;                                              // 0x0(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	float                                        StartTime;                                         // 0x18(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        EndTime;                                           // 0x1C(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1BB9[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
