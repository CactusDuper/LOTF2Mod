...
class URigVMMemory_Literal_IDLS : public URigVMMemoryStorage
{
public:
	...
	static class UClass* StaticClass();
	static class URigVMMemory_Literal_IDLS* GetDefaultObj();

};

// 0x1048 (0x1070 - 0x28)
// RigVMMemoryStorageGeneratorClass CR_IK_DigiLegs_Solver.RigVMMemory_Work
class URigVMMemory_Work_IDLS : public URigVMMemoryStorage
{
public:
	...
	uint8                                        Pad_3AB1[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3AB8[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3AC1[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UClass* StaticClass();
	static class URigVMMemory_Work_IDLS* GetDefaultObj();
