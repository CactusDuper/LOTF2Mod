...
{
public:
	uint8                                        Pad_712[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_713[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_714[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_716[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
