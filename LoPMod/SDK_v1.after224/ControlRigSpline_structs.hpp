...
{
public:
	uint8                                        Pad_358B[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_358C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3590[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3594[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                                     // 0xE0(0x90)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_FitChainToCurve_WorkData     WorkData;                                          // 0x170(0x98)(Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_3598[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
