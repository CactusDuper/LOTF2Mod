...
{
public:
	uint8                                        Pad_2C32[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C37[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C38[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
