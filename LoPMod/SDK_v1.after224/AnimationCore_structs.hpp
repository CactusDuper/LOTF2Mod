...
public:
	...
	uint8                                        Pad_24F9[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_24FA[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24FB[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_24FC[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_24FF[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
