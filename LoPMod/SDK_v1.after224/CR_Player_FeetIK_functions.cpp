...
class UClass* UCR_Player_FeetIK_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CR_Player_FeetIK_C");

	return Clss;
}


// CR_Player_FeetIK_C CR_Player_FeetIK.Default__CR_Player_FeetIK_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCR_Player_FeetIK_C* UCR_Player_FeetIK_C::GetDefaultObj()
{
	static class UCR_Player_FeetIK_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCR_Player_FeetIK_C*>(UCR_Player_FeetIK_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal CR_Player_FeetIK.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work CR_Player_FeetIK.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
