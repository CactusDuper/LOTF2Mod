...
struct ABP_BossMothsGate_C_ExecuteUbergraph_BP_BossMothsGate_Params
{
public:
	...
	class UNiagaraComponent*                     K2Node_DynamicCast_AsNiagara_Particle_System_Component; // 0x28(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
