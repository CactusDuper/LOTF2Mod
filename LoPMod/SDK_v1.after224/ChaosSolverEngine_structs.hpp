...
{
public:
	uint8                                        Pad_3278[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3279[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_327B[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
