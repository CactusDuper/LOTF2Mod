...
{
public:
	uint8                                        Pad_24CE[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24CF[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_24D3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24D4[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
