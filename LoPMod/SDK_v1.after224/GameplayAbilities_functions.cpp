...
void AGameplayCueNotify_Actor::OnOwnerEndPlay(class AActor* Actor, enum class EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGameplayCueNotify_Actor_OnOwnerEndPlay_Params Parms{};
...
class UClass* AAnathemaGameplayCueNotify_Actor::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AnathemaGameplayCueNotify_Actor");

	return Clss;
}


// AnathemaGameplayCueNotify_Actor GameplayAbilities.Default__AnathemaGameplayCueNotify_Actor
// (Public, ClassDefaultObject, ArchetypeObject)

class AAnathemaGameplayCueNotify_Actor* AAnathemaGameplayCueNotify_Actor::GetDefaultObj()
{
	static class AAnathemaGameplayCueNotify_Actor* Default = nullptr;

	if (!Default)
		Default = static_cast<AAnathemaGameplayCueNotify_Actor*>(AAnathemaGameplayCueNotify_Actor::StaticClass()->DefaultObject);
...
int32 UGameplayAbility::SendGameplayEvent(const struct FGameplayTag& EventTag, const struct FGameplayEventData& Payload)
{
	static class UFunction* Func = nullptr;
