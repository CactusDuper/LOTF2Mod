...
class UClass* ABP_Blood_Decals_Generator_Niagara_VFX_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Blood_Decals_Generator_Niagara_VFX_C");

	return Clss;
}


// BP_Blood_Decals_Generator_Niagara_VFX_C BP_Blood_Decals_Generator_Niagara_VFX.Default__BP_Blood_Decals_Generator_Niagara_VFX_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Blood_Decals_Generator_Niagara_VFX_C* ABP_Blood_Decals_Generator_Niagara_VFX_C::GetDefaultObj()
{
	static class ABP_Blood_Decals_Generator_Niagara_VFX_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Blood_Decals_Generator_Niagara_VFX_C*>(ABP_Blood_Decals_Generator_Niagara_VFX_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Blood_Decals_Generator_Niagara_VFX.BP_Blood_Decals_Generator_Niagara_VFX_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_Blood_Decals_Generator_Niagara_VFX_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Blood_Decals_Generator_Niagara_VFX_C", "ReceiveBeginPlay");
...
void ABP_Blood_Decals_Generator_Niagara_VFX_C::ReceiveParticleData(TArray<struct FBasicParticleData>& Data, class UNiagaraSystem* NiagaraSystem, struct FVector& SimulationPositionOffset)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Blood_Decals_Generator_Niagara_VFX_C", "ReceiveParticleData");

	Params::ABP_Blood_Decals_Generator_Niagara_VFX_C_ReceiveParticleData_Params Parms{};
