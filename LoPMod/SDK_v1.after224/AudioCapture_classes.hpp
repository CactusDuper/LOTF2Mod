...
{
public:
	uint8                                        Pad_2471[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	int32                                        JitterLatencyFrames;                               // 0x7A0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2472[0xBC];                                    // Fixing Size Of Struct [ Dumper-7 ]
