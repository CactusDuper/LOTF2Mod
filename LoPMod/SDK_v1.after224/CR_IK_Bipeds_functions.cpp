...
class UClass* UCR_IK_Bipeds_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CR_IK_Bipeds_C");

	return Clss;
}


// CR_IK_Bipeds_C CR_IK_Bipeds.Default__CR_IK_Bipeds_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCR_IK_Bipeds_C* UCR_IK_Bipeds_C::GetDefaultObj()
{
	static class UCR_IK_Bipeds_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCR_IK_Bipeds_C*>(UCR_IK_Bipeds_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal CR_IK_Bipeds.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work CR_IK_Bipeds.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
