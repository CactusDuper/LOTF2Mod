...
struct UAimTargetWidget_C_Get_Image_StabAvailable_Visibility_0_Params
{
public:
	...
	class UGameplayAbility*                      CallFunc_GetPrimaryAbilityInstanceByClass_ReturnValue; // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2896[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UGA_SyncedAttack*                      K2Node_DynamicCast_AsGA_Synced_Attack;             // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsSyncedAttackAvailableForActor_ReturnValue; // 0x31(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_2898[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UAimTargetWidget_C_ExecuteUbergraph_AimTargetWidget_Params
{
public:
