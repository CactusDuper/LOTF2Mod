...
struct UAN_PlayShakeFeedback_C_Received_Notify_Params
{
public:
	...
	float                                        CallFunc_PlayWorldShakeFeedback_radius_ImplicitCast; // 0x70(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
