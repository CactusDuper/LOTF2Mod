...
public:
	...
	uint8                                        BitPad_22F : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_232 : 2;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_234 : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_2CCE[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2CD4[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2CD9[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2CE8[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2CF1[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2CF2[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2CF3[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
