...
public:
	...
	TArray<class URootMotionModifier*>           Modifiers;                                         // 0xD0(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<struct FMotionWarpingTarget>          WarpTargets;                                       // 0xE0(0x10)(Net, ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_CF9[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_CFC[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CFD[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CFF[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D00[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
