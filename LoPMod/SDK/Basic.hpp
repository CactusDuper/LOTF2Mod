...
public:
	...
	inline void Add(const T& Element)
	{
		...
		{
			// Resize the array
			MaxElements = MaxElements * 2 + 1;  // You can use a different resizing strategy.
...
public:
	...
	using ToStringFunc = void(*)(const FName*, FString&);
	static inline ToStringFunc pToStringFunc = nullptr;
	...
	static inline void InitGNames()
	{
		...
		if (!pToStringFunc) {
			// Define a function pointer type that matches the signature of FName::ToString
			using ToStringFunc = void(*)(const FName*, FString&);
			MemoryManager memoryManager;
			auto gameBase = (uint64_t)GetModuleHandle(0);

			std::vector<void*> addrs = memoryManager.PatternScan("E8 ?? ?? ?? ?? 83 7D C8 00 48 8D 15 ?? ?? ?? ?? 48 8D 0D", 1);
			...
			pToStringFunc = reinterpret_cast<ToStringFunc>(functionAddress);
			addrs.clear();
			std::cout << "ign loop called" << std::endl;
		}
...
public:
	...
	uint8                                        Pad_4452[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4453[0x8];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x40[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_4454[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4455[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4456[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4457[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4458[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4459[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_445A[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_445B[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_445C[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
