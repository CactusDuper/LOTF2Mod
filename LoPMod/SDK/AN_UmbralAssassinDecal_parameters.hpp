...
struct UAN_UmbralAssassinDecal_C_Received_Notify_Params
{
public:
	...
	class ABP_FOE_UmbralAssassin_C*              K2Node_DynamicCast_AsBP_FOE_Umbral_Assassin;       // 0x48(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
