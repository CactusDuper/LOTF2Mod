...
{
public:
	uint8                                        Pad_5B4[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_605[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_627[0x100];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_635[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
