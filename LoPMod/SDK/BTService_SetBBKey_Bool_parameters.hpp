...
struct UBTService_SetBBKey_Bool_C_ReceiveActivationAI_Params
{
public:
...
struct UBTService_SetBBKey_Bool_C_ReceiveDeactivationAI_Params
{
public:
	class AAIController*                         OwnerController;                                   // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APawn*                                 ControlledPawn;                                    // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UBTService_SetBBKey_Bool_C_ExecuteUbergraph_BTService_SetBBKey_Bool_Params
{
public:
	...
	bool                                         CallFunc_GetBlackboardValueAsBool_ReturnValue;     // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
