...
{
public:
	uint8                                        Pad_1178[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_117F[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1180[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_118E[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
