...
public:
	...
	uint8                                        Pad_DF4[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DF5[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DF6[0xA0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E03[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
