...
class ABP_ITM_PLA_RuneOfAdyr_C : public AItemVisual
{
public:
	...
	static class ABP_ITM_PLA_RuneOfAdyr_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_ITM_PLA_RuneOfAdyr(int32 EntryPoint);
};
