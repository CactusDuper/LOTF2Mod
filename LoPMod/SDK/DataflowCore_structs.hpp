...
{
public:
	uint8                                        Pad_3506[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3508[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_350A[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
