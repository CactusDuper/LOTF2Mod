...
public:
	...
	uint8                                        Pad_C4[0xE];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_D1[0xC];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_17A[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	enum class EAREye                            Eye;                                               // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_17B[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
