...
{
public:
	uint8                                        Pad_2BE0[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2BEB[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2BED[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
