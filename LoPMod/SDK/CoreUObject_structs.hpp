...
public:
	...
	uint8                                        Pad_23[0x50];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24[0xD];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_26[0x38];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	inline double Dist(const FVector& V) const
	{
		double DX = X - V.X;
		double DY = Y - V.Y;
		double DZ = Z - V.Z;
...
public:
	...
	uint8                                        IsValid;                                           // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2F[0x7];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_32[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_37[0x3];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	float                                        InVal;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3D[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
