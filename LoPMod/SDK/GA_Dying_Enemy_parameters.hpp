...
struct UGA_Dying_Enemy_C_ExecuteUbergraph_GA_Dying_Enemy_Params
{
public:
	...
	class ABaseAIController*                     K2Node_DynamicCast_AsBase_AIController;            // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
