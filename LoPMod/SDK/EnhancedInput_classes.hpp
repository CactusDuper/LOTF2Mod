...
{
public:
	uint8                                        Pad_105B[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10CA[0x1A0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10CB[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FInputActionInstance>          ActionInstanceDatasPendingToClean;                 // 0x598(0x10)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                        Pad_10CD[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<struct FKey, struct FVector>            KeysPressedThisTick;                               // 0x648(0x50)(Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputAction*, struct FInjectedInputArray> InputsInjectedThisTick;                            // 0x698(0x50)(Transient, NativeAccessSpecifierPrivate)
	TSet<class UInputAction*>                    LastInjectedActions;                               // 0x6E8(0x50)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_10FB[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10FD[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_112E[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
