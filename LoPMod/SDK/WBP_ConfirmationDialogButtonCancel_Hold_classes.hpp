...
class UWBP_ConfirmationDialogButtonCancel_Hold_C : public UHexConfirmationDialogButton
{
public:
	...
	static class UWBP_ConfirmationDialogButtonCancel_Hold_C* GetDefaultObj();
	...
	void ExecuteUbergraph_WBP_ConfirmationDialogButtonCancel_Hold(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UCommonInputSubsystem* CallFunc_GetLocalPlayerSubsystem_ReturnValue, enum class ECommonInputType K2Node_CustomEvent_bNewInputType, bool K2Node_Event_IsDesignTime);
};
