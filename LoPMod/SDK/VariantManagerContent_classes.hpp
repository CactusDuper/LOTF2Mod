...
{
public:
	uint8                                        Pad_1EC5[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1EC8[0x77];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1EDD[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1EEE[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
