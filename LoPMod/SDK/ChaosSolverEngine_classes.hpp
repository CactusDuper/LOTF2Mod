...
{
public:
	uint8                                        Pad_2EB2[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2EB4[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2EB5[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2EBC[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2EBD[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
