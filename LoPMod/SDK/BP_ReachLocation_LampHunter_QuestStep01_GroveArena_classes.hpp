...
class ABP_ReachLocation_LampHunter_QuestStep01_GroveArena_C : public ANewAreaTrigger
{
public:
	...
	static class ABP_ReachLocation_LampHunter_QuestStep01_GroveArena_C* GetDefaultObj();
