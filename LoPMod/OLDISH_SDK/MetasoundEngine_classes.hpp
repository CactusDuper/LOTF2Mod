...
public:
	...
	uint8                                        Pad_2586[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2587[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2589[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_258A[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_258C[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
