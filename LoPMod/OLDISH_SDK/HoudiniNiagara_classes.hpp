...
public:
	...
	uint8                                        Pad_A27[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	class UHoudiniPointCache*                    HoudiniPointCacheAsset;                            // 0x38(0x8)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
