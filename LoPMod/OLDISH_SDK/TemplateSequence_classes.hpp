...
public:
	...
	uint8                                        Pad_CA7[0x7C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CAA[0x260];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CAB[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CB7[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CB8[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CB9[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
