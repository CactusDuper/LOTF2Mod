...
struct UGA_UseItemAbility_BP_C_K2_ShouldAbilityRespondToEvent_Params
{
public:
	...
	bool                                         CallFunc_EqualEqual_GameplayTag_ReturnValue;       // 0xFA(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
