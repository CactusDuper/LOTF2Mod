...
struct UGA_Resurrect_C_ExecuteUbergraph_GA_Resurrect_Params
{
public:
	...
	uint8                                        Pad_4074[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	double                                       CallFunc_MakeLiteralDouble_ReturnValue;            // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsWorldResetRequested_ReturnValue;        // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanAND_ReturnValue;                   // 0x19(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4075[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	float                                        CallFunc_StartCameraFade_Duration_ImplicitCast;    // 0x3C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Delay_Duration_ImplicitCast;              // 0x40(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
