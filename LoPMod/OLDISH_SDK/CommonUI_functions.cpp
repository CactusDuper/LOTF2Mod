...
class UClass* UCommonVideoSubtitleAsset::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CommonVideoSubtitleAsset");

	return Clss;
}


// CommonVideoSubtitleAsset CommonUI.Default__CommonVideoSubtitleAsset
// (Public, ClassDefaultObject, ArchetypeObject)

class UCommonVideoSubtitleAsset* UCommonVideoSubtitleAsset::GetDefaultObj()
{
	static class UCommonVideoSubtitleAsset* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonVideoSubtitleAsset*>(UCommonVideoSubtitleAsset::StaticClass()->DefaultObject);
