...
public:
	...
	uint8                                        Pad_EC3[0x110];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint32                                       MaxStreamRequestSizeKB;                            // 0x158(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	class UAnimBoneCompressionCodec*             SafetyFallbackCodec;                               // 0x38(0x8)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UAnimationCompressionLibraryDatabase*  DatabaseAsset;                                     // 0x38(0x8)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
