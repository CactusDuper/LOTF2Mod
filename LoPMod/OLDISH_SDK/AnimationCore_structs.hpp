...
public:
	...
	uint8                                        Pad_27DB[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27EA[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_27EB[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27EE[0xE0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
