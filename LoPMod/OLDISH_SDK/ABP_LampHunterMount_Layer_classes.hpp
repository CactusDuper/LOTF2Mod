...
{
public:
	uint8                                        Pad_4323[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	void ExecuteUbergraph_ABP_LampHunterMount_Layer(int32 EntryPoint, float CallFunc_GetCurveValueWithDefault_OutValue, bool CallFunc_GetCurveValueWithDefault_ReturnValue, float K2Node_Event_DeltaTimeX);
};
