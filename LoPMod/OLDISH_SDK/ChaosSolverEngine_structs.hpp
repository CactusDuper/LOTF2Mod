...
{
public:
	uint8                                        Pad_1A0D[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1A0E[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1A0F[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
