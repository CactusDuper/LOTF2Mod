...
{
public:
	uint8                                        Pad_19BF[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_19C1[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_19C3[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19CA[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
