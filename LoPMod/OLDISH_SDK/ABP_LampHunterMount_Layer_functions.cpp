...
void UABP_LampHunterMount_Layer_C::ExecuteUbergraph_ABP_LampHunterMount_Layer(int32 EntryPoint, float CallFunc_GetCurveValueWithDefault_OutValue, bool CallFunc_GetCurveValueWithDefault_ReturnValue, float K2Node_Event_DeltaTimeX)
{
	static class UFunction* Func = nullptr;
