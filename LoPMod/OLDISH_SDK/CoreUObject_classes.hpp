...
{
public:
	uint8                                        Pad_3[0x28];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	enum class EClassCastFlags                   CastFlags;                                         // (0xD8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_4[0x30];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0x110[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_5[0x118];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6[0x10];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E[0x18];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F[0x1C0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10[0xD0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13[0x8];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14[0x40];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]
