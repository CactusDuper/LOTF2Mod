...
{
public:
	uint8                                        Pad_20F1[0x130];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20F2[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20F4[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20FA[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
