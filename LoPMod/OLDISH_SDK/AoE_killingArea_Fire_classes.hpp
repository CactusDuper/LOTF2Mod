...
class AAoE_killingArea_Fire_C : public AGameplayEffectsAreaActor
{
public:
	...
	static class AAoE_killingArea_Fire_C* GetDefaultObj();

	void BPI_Close_Portculis();
	void BPI_Interact(class AActor* Actor_that_called, class AActor* InteractorPlayer);
	void ExecuteUbergraph_AoE_killingArea_Fire(int32 EntryPoint, class AActor* K2Node_Event_Actor_that_called, class AActor* K2Node_Event_InteractorPlayer);
};
