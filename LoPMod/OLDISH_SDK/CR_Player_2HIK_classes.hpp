...
class URigVMMemory_Literal_P2H : public URigVMMemoryStorage
{
public:
	...
	static class UClass* StaticClass();
	static class URigVMMemory_Literal_P2H* GetDefaultObj();

};

// 0x678 (0x6A0 - 0x28)
// RigVMMemoryStorageGeneratorClass CR_Player_2HIK.RigVMMemory_Work
class URigVMMemory_Work_P2H : public URigVMMemoryStorage
{
public:
	...
	uint8                                        Pad_3565[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3566[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3568[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_356A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UClass* StaticClass();
	static class URigVMMemory_Work_P2H* GetDefaultObj();
