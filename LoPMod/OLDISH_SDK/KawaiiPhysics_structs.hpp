...
public:
	...
	uint8                                        Pad_212B[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_213A[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_213F[0x4F];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2140[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
