...
class UW_Row_Usables_C : public UEquipmentCategoryRow
{
public:
	...
	static class UW_Row_Usables_C* GetDefaultObj();

	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_W_Row_Usables(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
