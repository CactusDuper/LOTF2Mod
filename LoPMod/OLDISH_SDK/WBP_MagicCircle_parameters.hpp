...
struct UWBP_MagicCircle_C_BP_UpdateActionsVisibility_Params
{
public:
...
struct UWBP_MagicCircle_C_PreConstruct_Params
{
public:
...
struct UWBP_MagicCircle_C_BP_SetIsUsable_Params
{
public:
	bool                                         bIsUsable;                                         // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x12 (0x12 - 0x0)
// Function WBP_MagicCircle.WBP_MagicCircle_C.ExecuteUbergraph_WBP_MagicCircle
struct UWBP_MagicCircle_C_ExecuteUbergraph_WBP_MagicCircle_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_bVisible;                             // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_IsDesignTime;                         // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_bIsUsable;                            // 0x6(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3D5B[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
