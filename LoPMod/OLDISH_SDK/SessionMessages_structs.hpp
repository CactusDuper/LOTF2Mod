...
public:
	...
	uint8                                        Pad_3557[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3558[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3559[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_355A[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
